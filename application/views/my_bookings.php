                            ...
                            <tbody>
                                <?php foreach ($data as $row): ?>
                                    <tr>
                                        ...
                                        <td><div id="myDiagram<?php echo $row->id; ?>" style="width:500px; height:200px;"></div></td>
                                    ...
                                    <script>
                                        ...
                                        var myDiagram =
                                            ...
                                            myDiagram.model = new go.GraphLinksModel(
                                                [
                                                { key: "<?php echo $row->rider; ?>", color: "lightblue" },
                                                { key: "<?php echo $row->driver; ?>", color: "orange" },
                                                { key: "<?php echo $destination; ?>", color: "lightgreen" }
                                                ],
                                                [
