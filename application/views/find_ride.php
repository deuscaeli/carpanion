    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                <h1 class="mb-2 bread">Find a ride</h1>
                <p class="breadcrumbs"><span class="mr-2"><a href="<?=base_url();?>">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Find a ride <i class="ion-ios-arrow-forward"></i></span></p>
            </div>
        </div>
    </div>
</section>
...
<script>
    $(document).ready(function() {
        ...
        $("#find_ride").submit(function(event){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('find_ride/find_ride_action') ?>",
                data: thidata,
                dataType : "json",
